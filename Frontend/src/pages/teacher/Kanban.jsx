...
// ─── Storage ──────────────────────────────────────────────
const STORAGE_KEY = "smartcampus_teacher_kanban_v1";
...
const DEFAULT_CARDS = {
  todo: [
    { id: "t1", title: "Plan weekly lesson", desc: "Prepare for Monday", priority: "high" },
  ],
  inprogress: [
    { id: "t2", title: "Grade assignments", desc: "Class 9B submissions", priority: "high" },
  ],
  review: [
    { id: "t3", title: "Update curriculum", desc: "Q3 syllabus update", priority: "medium" },
  ],
  done: [
    { id: "t4", title: "Parent meeting notes", desc: "Completed last week", priority: "low" },
  ],
};
...
// ─── Task Card ────────────────────────────────────────────
function TaskCard({ card, colId, colBg, columns, onDragStart, onEdit, onDelete, onMove }) {
